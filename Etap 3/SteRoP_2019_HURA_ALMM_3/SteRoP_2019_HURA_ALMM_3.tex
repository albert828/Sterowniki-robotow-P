...
K_{i} = 2 \ast \frac{K_{p}}{P_{u}} \ = 0.44 \newline
K_{d} = \frac{K_{p}\ast P_{u}}{8} \ = 0.33 \newline
...
\bibitem{forbot1}
  www.forbot.pl,
  \emph{Kurs STM32 F1 HAL – #7 – liczniki (timery) w praktyce, PWM}
  
  \bibitem{forbot2}
  www.forbot.pl,
  \emph{Jak zaimplementować regulator PID dla silnika z enkoderem?}
