...
\newcommand{\osobaB}{Michał \textsc{Moruń}, XXX}
...
\section{Założenia projektowe}
	...
	\begin{enumerate}
		\item Napęd
		\newline
		Napęd będzie realizowany na tylnią oś za pomocą silnika szczotkowego DC. Regulacja prędkości oparta o regulator PID i PWM/
	...
	\begin{enumerate}
		...
		\newline
		Realizowany za pomocą enkoderów znajdujących się w kołach/osi robota.
		
		\item Zasilanie
		\newline
		Oparte o akumulatory li-ion 18650 lub powerbank. Dopasowanie napięcia za pomocą przetwornicy step-up MT36?? oraz step-down ???
	\end{enumerate}
	...
	\begin{enumerate}
		...
		\newline
		Realizowane za pomocą modułu Wi-Fi esp8266 lub modułu bluetooth ????. W telefonie do komunikacji posłuży aplikacja RoboRemo.
	\end{enumerate}
...
\subsection{Kamienie milowe}
	\begin{enumerate}
		\item Zbudowanie działającego prototypu sterowanego joystickiem na płytce.
		\item Zaimplementowanie regulacji prędkości w oparciu o regulator PID.
		\item Zaimplementowanie sterowania smartfonem.
	\end{enumerate}
